                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group local-forms">
                                    ...
                                    <input class="form-control" type="text" placeholder="Digite o nome" required
                                        name="first_name" value="{{ $manager->first_name }}" id="validationServer01">
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group local-forms">
                                    ...
                                    <input class="form-control" type="text" placeholder="Digite o apelido" required
                                        name="last_name" value="{{ $manager->last_name }}">
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group local-forms">
                                    ...
                                    <select class="form-control select" required name="extension_id">
                                        ...
                                        @foreach ($extensions as $tipo)
                                            <option {{ $manager->extension_id == $tipo->id ? 'selected' : '' }}
                                                value="{{ $tipo->id }}">
                                                {{ $tipo->city }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="form-group local-forms">
                                    ...
                                    <select class="form-control select" required name="document_type_id">
                                        ...
                                        @foreach ($documentTypes as $tipo)
                                            <option {{ $manager->document_type_id == $tipo->id ? 'selected' : '' }}
                                                value="{{ $tipo->id }}">
                                                {{ $tipo->label }} </option>
                                        @endforeach
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group local-forms">
                                    ...
                                    <input class="form-control" type="text" placeholder="Digite o Numero de Documento"
                                        name="document_number" value="{{ $manager->document_number }}" required>
                                    <div class="invalid-feedback">
                                        Campo obrigatório.
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group local-forms">
                                    ...
                                    <input class="form-control" type="text" placeholder="Digite o local de emissao"
                                        name="issue_place" value="{{ $manager->issue_place }}" required>
                                    <div class="invalid-feedback">
                                        Campo obrigatório.
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group local-forms">
                                    ...
                                    <input class="form-control" type="text" placeholder="Digite o numero de telefone"
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group local-forms">
                                    ...
                                    <input class="form-control" type="email" placeholder="Digite o email" name="email"
                                        required value="{{ $manager->email }}" id="validationCustom03">
                                    <div class="invalid-feedback">
                            ...
                            @if ($dadosUsuario->nivel == 'A')
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <select class="form-control select" required name="nivel">
                                            <option value="">Selecione o Nível </option>

                                            <option {{ $manager->nivel == 'B' ? 'selected' : '' }} value="B">B
                                            </option>
                                            <option {{ $manager->nivel == 'C' ? 'selected' : '' }} value="C">C
                                            </option>
                                            <option {{ $manager->nivel == 'D' ? 'selected' : '' }} value="D">D
                                            </option>
                                            <option {{ $manager->nivel == 'A' ? 'selected' : '' }} value="A">A
                                            </option>
                                        </select>
                                        <div class="invalid-feedback">
                                            Campo obrigatório.
