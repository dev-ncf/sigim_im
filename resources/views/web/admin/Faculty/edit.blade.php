                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group local-forms">
                                    ...
                                    <input class="form-control" type="text" placeholder="Nome da faculdade ..." required
                                        name="label" value="{{ $faculty->label }}">
                                ...
                                <div class="form-group local-forms">
                                    ...
                                    <select class="form-control" type="text" required name="extension_id">
                                        ...
                                        @foreach ($extensaos as $extensao)
                                            <option {{ $faculty->extension_id == $extensao->id ? 'selected' : '' }}
                                                value="{{ $extensao->id }}">
