			...
			<div class="col-sm-12">
				<div class="page-sub-header">
					...
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item active">Editar Propina</li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="col-sm-12">
			<div class="card comman-shadow">
				<div class="card-body">
					...
					<form method="post" action="{{ route('admin-propina-update', $movementStudent->id) }}" class="needs-validation"
						novalidate>
						@csrf
						<div class="row">
							<div class="col-12">
							...
							<div class="col-12 col-sm-4">
								<div class="form-group local-forms">
									...
									<input type="text" class="form-control" placeholder="Pesquisar estudante..."
										value="{{ $movementStudent->student->first_name . ' ' . $movementStudent->student->last_name }}" readonly>
								</div>
							</div>
							<div class="col-12 col-sm-4">
								<div class="form-group local-forms">
									...
									<input class="form-control" type="number" placeholder="Numero de Recibo" required name="receipt_number"
										value="{{ $movementStudent->receipt_number }}">
							...
							<div class="col-12 col-sm-4">
								<div class="form-group local-forms">
									...
									<input id="valor" class="form-control" type="number" min="1000" required placeholder="Valor total"
										name="total_amount" value="{{ $movementStudent->total_amount }}">
									<div class="invalid-feedback">
							...
							<div class="col-12 col-sm-4">
								<div class="form-group local-forms">
									...
									<select class="form-control select" required name="month">
										...
										<option {{ $movementStudent->month == 1 ? 'selected' : '' }} value="1">1º</option>
										<option {{ $movementStudent->month == 2 ? 'selected' : '' }} value="2">2º</option>
										<option {{ $movementStudent->month == 3 ? 'selected' : '' }} value="3">3º</option>
										<option {{ $movementStudent->month == 4 ? 'selected' : '' }} value="4">4º</option>
										<option {{ $movementStudent->month == 5 ? 'selected' : '' }} value="5">5º</option>
										<option {{ $movementStudent->month == 6 ? 'selected' : '' }} value="6">6º</option>
										<option {{ $movementStudent->month == 7 ? 'selected' : '' }} value="7">7º</option>
									</select>
									<div class="invalid-feedback">
										Campo obrigatório..
									</div>
							...
							<div class="col-12 col-sm-4">
								<div class="form-group local-forms">
									...
									<input class="form-control" required name="year" type="number" min="2023" placeholder="Ano da Propina"
										value="{{ $movementStudent->year }}">
									<div class="invalid-feedback">
							...
							<div class="col-12 col-sm-4">
								<div class="form-group local-forms">
									...
									<select class="form-control select" required name="semestre">
										...
										<option {{ $movementStudent->semestre == 1 ? 'selected' : '' }} value="1">1º</option>
										<option {{ $movementStudent->semestre == 2 ? 'selected' : '' }} value="2">2º</option>
										<option {{ $movementStudent->semestre == 3 ? 'selected' : '' }} value="3">3º</option>
										<option {{ $movementStudent->semestre == 4 ? 'selected' : '' }} value="4">4º</option>
									</select>
									<div class="invalid-feedback">
										Campo obrigatório..
									</div>
