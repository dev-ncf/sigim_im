            ...
            <div class="card comman-shadow">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('student-update', $student->id) }}" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h5 class="form-title student-info"> Informações do Estudante <span><a
                                            href="javascript:;"><i class="feather-more-vertical"></i></a></span></h5>
                            </div>
                            <div class="col-12 col-sm-4">
                                <div class="form-group local-forms">
                                    <label>First Name <span class="login-danger">*</span></label>
                                    <input class="form-control" type="text" value="{{ $student->first_name }}" required
                                        name="first_name">
                                </div>
                            </div>
                            <div class="col-12 col-sm-4">
                                <div class="form-group local-forms">
                                    ...
                                    <input class="form-control" type="text" value="{{ $student->last_name }}" required
                                        name="last_name">
                                </div>
                            </div>
                            <div class="col-12 col-sm-4">
                                ...
                                <div class="form-group local-forms">
                                    ...
                                    <select class="form-control select" name="course_id">
                                        @foreach ($courses as $index => $course)
                                            <option
                                                {{ $index + 1 == $student->studentEnrollment[0]->course_id ? 'selected' : '' }}>
                                                {{ $course->label }}</option>
                                        @endforeach
                                    </select>
