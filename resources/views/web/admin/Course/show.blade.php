	...
	<div class="page-header">
		<div class="row">
			<div class="col">
				...
				<ul class="breadcrumb">
					<li class="breadcrumb-item"><a href="index.html">Curso</a></li>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="profile-header">
				<div class="row align-items-center">
					...
					<div class="col ms-md-n2 profile-user-info">
						<h4 class="user-name mb-0">{{ $course->label }}</h4>
						<div class="user-Location"><i class="fas fa-map-marker-alt"></i> {{ $course->faculty->label }}</div>
			...
			<div class="tab-content profile-tab-cont">
				...
				<div id="students_tab" class="tab-pane fade show active">
					<div class="row">
						<div class="col-sm-12">
