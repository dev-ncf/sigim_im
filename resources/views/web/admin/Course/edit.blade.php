		...
		<div class="col-sm-12">
			<div class="card comman-shadow">
				<div class="card-body">
					...
					<form method="post" action="{{ route('course-update') }}" enctype="multipart/form-data" class="needs-validation"
						novalidate>
						@csrf
						<div class="row">
							<div class="col-12">
								...
								<div class="form-group local-forms">
									...
									<select class="form-control" type="text" required name="faculty_id">
										...
										@foreach ($faculties as $faculty)
											<option {{ $course->faculty_id == $faculty->id ? 'selected' : '' }} value="{{ $faculty->id }}">
												{{ $faculty->label }}</option>
										@endforeach
									</select>
									<div class="invalid-feedback">
										Campo obrigatório.
