						...
						<div class="row">
							...
							<div class="col-12 col-sm-4">
								<div class="form-group local-forms">
									...
									@foreach ($estudantes as $estudante)
                                        <option value="{{ $estudante->id }}">{{ $estudante->truncateName($estudante->first_name.' '.$estudante->last_name) }}</option>
                                    @endforeach
                                </select>
							...
							<div class="col-12 col-sm-4">
								<div class="form-group local-forms ">
									...
									<input class="form-control " type="number" placeholder="Numero de disciplinas a frequentar" required name="numero_disciplinas">
                                    <div class="invalid-feedback">
                                        Campo obrigatório.
                                    </div>
								</div>
