                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a
                                                        href="{{ route('student-show', $student->id) }}">{{ $student->truncateName($student->first_name . ' ' . $student->last_name) }}</a>
                                                </h2>
                                            ...
                                            <td><span
                                                    style="padding: 3px 8px; {{ $enrollment->enrollment_status == 2 ? 'background-color: #0080004a; color: #009000' : ($enrollment->enrollment_status == 1 ? 'background-color: #ffa5004a; color: #ffa500' : 'background-color: #1108004a; color: #000000') }}">
                                                    {{ $enrollment->enrollment_status == 2 ? 'Aprovada' : ($enrollment->enrollment_status == 1 ? 'Pendente' : 'Inicial') }}
                                                </span>
                                            ...
                                            <td class="text-end">
                                                <div class="actions">
                                                    ...
                                                    @if ($dadosUsuario->nivel == 'A')
                                                        <a href="#" id="delete-{{ $enrollment->id }}"
