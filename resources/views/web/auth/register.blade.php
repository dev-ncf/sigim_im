...
@section('content')
	<div class="card">
		...
		<form style="background-color: red" class="div-form-begin registration-begin" id="div-form1"
			onsubmit="hideDivForm('div-form1', 'div-form2')">
			...
			<div class="div-100" style="text-align: center;">
				<button class="btn-next" id="btn-hide-form1" type="button" style=" border: solid 1px blue">
		...
		<form class="div-form-begin registration-begin" id="div-form2" onsubmit="hideDivForm('div-form2', 'div-form3')">
			...
			<div class="form-group div-30">
				...
				<input class="input-begin" type="date" name="student-birth-date" max="2000-01-01" id="student-birth-date"
					required>
			</div>
			<div class="form-group div-30">
			...
			<div class="form-group div-100">
				<label for="">Possui alguma necessidade educativa especial?
					<span style="margin-left: 25px;">
						<input type="radio" class="special-needs" name="special-need" id="special-need-yes" value="1" required>
						Sim
					</span>
					<span style="margin-left: 15px;">
						<input type="radio" class="special-needs" name="special-need" id="special-need-no" value="0" required>
						Não
					</span>
				</label>
			</div>
		...
		<form class="div-form-begin registration-begin" id="div-form4" onsubmit="hideDivForm('div-form4', 'div-form5')">
			...
			<div class="form-group div-50">
				...
				<input class="input-begin" type="number" min="1" minlength="9" maxlength="9" name=""
					id="student-main-phone" required>
			</div>
			<div class="form-group div-50">
				<label for="">Telefone alternativo</label>
				<input class="input-begin" type="number" min="1" minlength="9" maxlength="9" name=""
					id="student-secondary-phone">
			</div>
			<div class="form-group div-100">
				<label for="">Email</label>
				<input class="input-begin" type="email" id="student-email" name="student-email" value="{{ $email }}"
					disabled required>
			</div>
			<div class="div-100" style="text-align: center;">
		...
		<form class="div-form-begin registration-begin" id="div-form5" onsubmit="hideDivForm('div-form5', 'div-form6')">
			...
			<div class="form-group div-50">
				...
				<input class="input-begin" type="number" min="1970" max="{{ date('Y') - 4 }}"
					id="student-previous-license-start-year" required>
			</div>
			<div class="form-group div-50">
				<label for="">Ano de termino</label>
				<input class="input-begin" type="number" min="1970" max="{{ date('Y') }}"
					id="student-previous-license-end-year" required>
			</div>
			<div class="div-100" style="text-align: center;">
		...
		<form class="div-form-begin registration-begin" id="div-form6" onsubmit="hideDivForm('div-form6', 'div-form7')">
			...
			<div class="form-group div-50">
				...
				<input class="input-begin" type="number" min="1970" max="{{ date('Y') }}" name=""
					id="student-professional-career-start-year">
			</div>
			<div class="form-group div-50">
				<label for="">Ano de termino</label>
				<input class="input-begin" type="number" min="1970" max="{{ date('Y') }}" name=""
					id="student-professional-career-end-year">
			</div>
			<div class="form-group div-100">
		...
		<form class="div-form-begin registration-begin" id="div-form7" onsubmit="hideDivForm('div-form7', 'div-form8')">
			...
			<div class="div-100" style="margin: 10px 0; padding: 5px;  background-color:#3997bc;">
				<legend style="font-size: 12pt; text-align: center; font-weight: 600; color: #fff;">Composição do Agregado Familiar
				</legend>
			</div>
			<div class="form-group div-60">
		...
		<form class="div-form-begin registration-begin" id="div-form8" onsubmit="hideDivForm('div-form8', 'div-form9')">
			...
			<div class="form-group div-100">
				<label for="">Possui uma bolsa?
					...
					<input type="radio" name="student-scholarship" id="scholarship-yes" value="1" style="margin-left: 15px;"
						required> <span style="margin-right: 15px;">Sim</span>
			...
			<div class="div-100" style="margin: 10px 0; padding: 5px;  background-color:#3997bc;">
				<legend style="font-size: 12pt; text-align: center; font-weight: 600; color: #fff;">Como tomou conhecimento do Curso
				</legend>
			</div>
		...
		<form class="div-form-begin registration-begin" id="div-form9">
			...
			<div class="form-group div-100">
				<p style="font-size: 10pt; margin: 10px 0; color:#3d3c3c;"><span
						style="color: #ff0000; font-weight: 700;">Atenção:</span> Anexar os seguintes documentos autenticados(Certificado
					e Bilhete de Identidade), Declaração Militar e NUIT</p>
			</div>
			<div class="form-group div-50">
