...
<head>
	...
	<link href="https://cdn.jsdelivr.net/npm/bootstrap@4.2.3/dist/css/bootstrap.min.css"
		rel="stylesheet"
...
<body>
	...
	<div class="div-home">
		<aside>
			...
			<ul>
				<li @yield('active-home')><a href="{{ route('home-manager') }}"> <i
							class="bi bi-card-text"></i> Inscrições</a></li>
				<li @yield('active-perfil')><a href="{{ route('perfil-manager') }}"> <i
							class="bi bi-person-bounding-box"></i> Personaliza&ccedil;&atilde;o</a></li>
			</ul>
		</aside>
