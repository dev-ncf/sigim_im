        ...
        <div class="header">
            ...
            <div class="header-left">
                <a href="{{ route('home-admin') }}" class="logo">
                    ...
                    <span
                        style="font-size: 12pt;display: block;margin-left: 60px; margin-top:-43px; color: rgb(231, 72, 14)">Registo
                        Académico</span>
                    ...
                    <div class="dropdown-menu">
                        <div class="user-header">
                            <div class="avatar avatar-sm">
                                <img src="{{ $dadosUsuario->first_name == 'Ntwali Chance' ? asset('assets/img/profiles/avatar-01.jpg') : asset('img/logo.jpg') }}"
                    ...
                    <ul>
                            ...
                            <li
                                ...
                                <ul>
                                    <li><a href="{{ route('manager-list') }}"
                                            class="{{ request()->routeIs('manager-list') ? 'active' : '' }}">
                                            Lista</a></li>
                                    <li><a href="{{ route('manager-add') }}"
                                            class="{{ request()->routeIs('manager-add') ? 'active' : '' }}">Add</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
                        <li
                            ...
                            <ul>
                                <li><a href="{{ route('student-list') }}"
                                        class="{{ request()->routeIs('student-list') ? 'active' : '' }}">
                                        Lista</a></li>
                                <li><a href="{{ route('student-add') }}"
                                        class="{{ request()->routeIs('student-add') ? 'active' : '' }}">
                                        Add</a></li>
                            </ul>
                        </li>
                        ...
                        @if ($dadosUsuario->nivel == 'A')
                            <li
                                ...
                                <a href="#"><i class="fa fa-school"></i> <span> Faculdades</span> <span
                                        class="menu-arrow"></span></a>
                                <ul>
                            ...
                            <li
                                ...
                                <a href="#"><i class="fa fa-book"></i> <span> Cursos</span> <span
                                        class="menu-arrow"></span></a>
                                <ul>
                            ...
                            <li
                                ...
                                <a href="#"><i class="fa fa-book"></i> <span> P. de Inscrições</span> <span
                                        class="menu-arrow"></span></a>
                                <ul>
